...
class FileProvider extends BaseProvider
{
    ...
    {
        return new Metadata($this->getName(), $this->getName().'.description', false, 'MikyMediaBundle', array('class' => 'fa fa-file-text-o'));
    }
    ...
    public function getDownloadResponse(MediaInterface $media, $format, $mode, array $headers = array())
    {
        ...
        if (!$this->getFilesystem()->getAdapter() instanceof \Miky\Bundle\MediaBundle\Filesystem\Local) {
            throw new \RuntimeException('Cannot use X-Sendfile or X-Accel-Redirect with non \Miky\Bundle\MediaBundle\Filesystem\Local');
        }
