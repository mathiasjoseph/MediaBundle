...
class Pixlr
{
    ...
    public function exitAction($hash, $id)
    {
        ...
        return new Response($this->templating->render('MikyMediaBundle:Extra:pixlr_exit.html.twig'));
    }
    ...
    public function openEditorAction($id)
    {
        ...
        return new Response($this->templating->render('MikyMediaBundle:Extra:pixlr_editor.html.twig', array(
            'media' => $media,
