...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $node = $treeBuilder->root('adevis_media');
                    ...
                    ->prototype('array')
                        ->children()
                            ->arrayNode('download')
                                ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('strategy')->defaultValue('adevis.media.security.superadmin_strategy')->end()
                ...
                ->arrayNode('providers')
                    ...
                    ->children()
                        ->arrayNode('file')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('service')->defaultValue('adevis.media.provider.file')->end()
                                ->scalarNode('resizer')->defaultValue(false)->end()
                                ->scalarNode('filesystem')->defaultValue('adevis.media.filesystem.local')->end()
                                ->scalarNode('cdn')->defaultValue('adevis.media.cdn.server')->end()
                                ->scalarNode('generator')->defaultValue('adevis.media.generator.default')->end()
                                ->scalarNode('thumbnail')->defaultValue('adevis.media.thumbnail.format')->end()
                        ...
                        ->arrayNode('image')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('service')->defaultValue('adevis.media.provider.image')->end()
                                ->scalarNode('resizer')->defaultValue('adevis.media.resizer.default')->end()
                                ->scalarNode('filesystem')->defaultValue('adevis.media.filesystem.local')->end()
                                ->scalarNode('cdn')->defaultValue('adevis.media.cdn.server')->end()
                                ->scalarNode('generator')->defaultValue('adevis.media.generator.default')->end()
                                ->scalarNode('thumbnail')->defaultValue('adevis.media.thumbnail.format')->end()
                                ->scalarNode('adapter')->defaultValue('adevis.media.adapter.image.default')->end()
                                ->arrayNode('allowed_extensions')
                                    ->prototype('scalar')->end()
                        ...
                        ->arrayNode('youtube')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('service')->defaultValue('adevis.media.provider.youtube')->end()
                                ->scalarNode('resizer')->defaultValue('adevis.media.resizer.default')->end()
                                ->scalarNode('filesystem')->defaultValue('adevis.media.filesystem.local')->end()
                                ->scalarNode('cdn')->defaultValue('adevis.media.cdn.server')->end()
                                ->scalarNode('generator')->defaultValue('adevis.media.generator.default')->end()
                        ...
                        ->arrayNode('dailymotion')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('service')->defaultValue('adevis.media.provider.dailymotion')->end()
                                ->scalarNode('resizer')->defaultValue('adevis.media.resizer.default')->end()
                                ->scalarNode('filesystem')->defaultValue('adevis.media.filesystem.local')->end()
                                ->scalarNode('cdn')->defaultValue('adevis.media.cdn.server')->end()
                                ->scalarNode('generator')->defaultValue('adevis.media.generator.default')->end()
                        ...
                        ->arrayNode('vimeo')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('service')->defaultValue('adevis.media.provider.vimeo')->end()
                                ->scalarNode('resizer')->defaultValue('adevis.media.resizer.default')->end()
                                ->scalarNode('filesystem')->defaultValue('adevis.media.filesystem.local')->end()
                                ->scalarNode('cdn')->defaultValue('adevis.media.cdn.server')->end()
                                ->scalarNode('generator')->defaultValue('adevis.media.generator.default')->end()
        ...
        $node
            ->children()
                ->arrayNode('buzz')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('connector')->defaultValue('adevis.media.buzz.connector.curl')->end()
                        ->arrayNode('client')
                        ->addDefaultsIfNotSet()
                        ->children()
        ...
        $node
            ->children()
                ...
                ->arrayNode('resizers')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('default')->defaultValue('adevis.media.resizer.simple')->end()
                    ->end()
                ->end()
            ->end()
        ;
        ...
        $node
            ->children()
                ->arrayNode('adapters')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('default')->defaultValue('adevis.media.adapter.image.gd')->end()
                    ->end()
                ->end()
            ->end()
        ;
