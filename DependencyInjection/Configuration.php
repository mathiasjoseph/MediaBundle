...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $node = $treeBuilder->root('miky_media');
                    ...
                    ->prototype('array')
                        ->children()
                            ->arrayNode('download')
                                ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('strategy')->defaultValue('miky.media.security.superadmin_strategy')->end()
                ...
                ->arrayNode('providers')
                    ...
                    ->children()
                        ->arrayNode('file')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('service')->defaultValue('miky.media.provider.file')->end()
                                ->scalarNode('resizer')->defaultValue(false)->end()
                                ->scalarNode('filesystem')->defaultValue('miky.media.filesystem.local')->end()
                                ->scalarNode('cdn')->defaultValue('miky.media.cdn.server')->end()
                                ->scalarNode('generator')->defaultValue('miky.media.generator.default')->end()
                                ->scalarNode('thumbnail')->defaultValue('miky.media.thumbnail.format')->end()
                        ...
                        ->arrayNode('image')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('service')->defaultValue('miky.media.provider.image')->end()
                                ->scalarNode('resizer')->defaultValue('miky.media.resizer.default')->end()
                                ->scalarNode('filesystem')->defaultValue('miky.media.filesystem.local')->end()
                                ->scalarNode('cdn')->defaultValue('miky.media.cdn.server')->end()
                                ->scalarNode('generator')->defaultValue('miky.media.generator.default')->end()
                                ->scalarNode('thumbnail')->defaultValue('miky.media.thumbnail.format')->end()
                                ->scalarNode('adapter')->defaultValue('miky.media.adapter.image.default')->end()
                                ->arrayNode('allowed_extensions')
                                    ->prototype('scalar')->end()
                        ...
                        ->arrayNode('youtube')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('service')->defaultValue('miky.media.provider.youtube')->end()
                                ->scalarNode('resizer')->defaultValue('miky.media.resizer.default')->end()
                                ->scalarNode('filesystem')->defaultValue('miky.media.filesystem.local')->end()
                                ->scalarNode('cdn')->defaultValue('miky.media.cdn.server')->end()
                                ->scalarNode('generator')->defaultValue('miky.media.generator.default')->end()
                        ...
                        ->arrayNode('dailymotion')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('service')->defaultValue('miky.media.provider.dailymotion')->end()
                                ->scalarNode('resizer')->defaultValue('miky.media.resizer.default')->end()
                                ->scalarNode('filesystem')->defaultValue('miky.media.filesystem.local')->end()
                                ->scalarNode('cdn')->defaultValue('miky.media.cdn.server')->end()
                                ->scalarNode('generator')->defaultValue('miky.media.generator.default')->end()
                        ...
                        ->arrayNode('vimeo')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('service')->defaultValue('miky.media.provider.vimeo')->end()
                                ->scalarNode('resizer')->defaultValue('miky.media.resizer.default')->end()
                                ->scalarNode('filesystem')->defaultValue('miky.media.filesystem.local')->end()
                                ->scalarNode('cdn')->defaultValue('miky.media.cdn.server')->end()
                                ->scalarNode('generator')->defaultValue('miky.media.generator.default')->end()
        ...
        $node
            ->children()
                ->arrayNode('buzz')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('connector')->defaultValue('miky.media.buzz.connector.curl')->end()
                        ->arrayNode('client')
                        ->addDefaultsIfNotSet()
                        ->children()
        ...
        $node
            ->children()
                ...
                ->arrayNode('resizers')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('default')->defaultValue('miky.media.resizer.simple')->end()
                    ->end()
                ->end()
            ->end()
        ;
        ...
        $node
            ->children()
                ->arrayNode('adapters')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('default')->defaultValue('miky.media.adapter.image.gd')->end()
                    ->end()
                ->end()
            ->end()
        ;
